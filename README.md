...
```
cd existing_repo
git remote add origin https://gitlab.com/frugalResolution/WebLetterManager.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/frugalResolution/WebLetterManager/-/settings/integrations)
